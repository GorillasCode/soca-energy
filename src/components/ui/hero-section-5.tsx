...
import { ButtonLegacy as Button } from "@/components/ui/button-legacy"
          ...
          <div className="relative py-24 md:pb-32 lg:pb-36 lg:pt-72">
            <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-semibold tracking-tight md:text-6xl lg:mt-16 xl:text-7xl">
            ...
            <div className="absolute inset-1 -z-0 aspect-[2/3] overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5">
              <video
                autoPlay
                loop
                muted
                ...
                <InfiniteSlider speed={40} speedOnHover={20} gap={112}>
                  <div className="flex">
                    <Image
                      ...
                      src="https://images.unsplash.com/photo-1614732414444-096e5f1122d5?w=120&h=40&fit=crop&q=80"
                      alt="Partner brand"
                      height={20}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      ...
                      src="https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=120&h=32&fit=crop&q=80"
                      alt="Partner brand"
                      height={16}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      className="mx-auto h-4 w-auto dark:invert"
                      src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=120&h=32&fit=crop&q=80"
                      alt="Partner brand"
                      height={16}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      className="mx-auto h-5 w-auto dark:invert"
                      src="https://images.unsplash.com/photo-1542293787936-4d201fe4261f?w=120&h=40&fit=crop&q=80"
                      alt="Partner brand"
                      height={20}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      className="mx-auto h-5 w-auto dark:invert"
                      src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=120&h=40&fit=crop&q=80"
                      alt="Partner brand"
                      height={20}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      className="mx-auto h-4 w-auto dark:invert"
                      src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=120&h=32&fit=crop&q=80"
                      alt="Partner brand"
                      height={16}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      ...
                      src="https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=120&h=48&fit=crop&q=80"
                      alt="Partner brand"
                      height={28}
                      width={80}
                    />
                  ...
                  <div className="flex">
                    <Image
                      ...
                      src="https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=120&h=40&fit=crop&q=80"
                      alt="Partner brand"
                      height={24}
                      width={80}
                    />
